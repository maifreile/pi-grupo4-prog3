...
class TodasCartelera extends Component {
      ...
      .then((data) => {
        setTimeout(() => {
          this.setState((prevState) => ({
            ...
            paginaACargar: prevState.paginaACargar + 1, // Incrementa la página
  ...
  filtrarPeliculas = (peli) => {
    ...
    this.setState({ peliculasFiltradas: pelisFiltradas }); // Actualiza el estado de películas filtradas
  };
  ...
  render() {
    return (
      <div className="cardContainer">
        <div className="todas">
          <h1 className="tituloTodas">Películas en cartelera</h1>
